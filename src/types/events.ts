...
export class AuctionsBidAcceptedEvent {
   ...
   */
  get isV9010(): boolean {
    return this.ctx._chain.getEventHash('auctions.BidAccepted') === '02d7badf9f8b02f043ed83365af4040117e15ce338c04f0f39488f7fceb3ff33'
  }
...
export class AuctionsReservedEvent {
   ...
   */
  get isV9010(): boolean {
    return this.ctx._chain.getEventHash('auctions.Reserved') === '787a0023d4d1b55dfb45e23e339a9a7d31cd4323816d6930f58ec565efb2e64b'
  }
...
export class AuctionsUnreservedEvent {
   ...
   */
  get isV9010(): boolean {
    return this.ctx._chain.getEventHash('auctions.Unreserved') === '655b54395ff5599b25bca1b094fa2beef5a393bf3e792d0365a1329f8596fc5d'
  }
...
export class RegistrarRegisteredEvent {
  ...
  get isV9010(): boolean {
    return this.ctx._chain.getEventHash('registrar.Registered') === '958b1a32401a8ea8f2534d942feaf20b4f5c76ceb4825231b325944b10f35b5b'
  }
...
export class SlotsLeasedEvent {
   ...
   */
  get isV9010(): boolean {
    return this.ctx._chain.getEventHash('slots.Leased') === 'fb0643f9dea9c215c8d64de7ba7aa6f05f0c6d979848db35de9c75e071242c7c'
  }
...
export class VestingVestingCompletedEvent {
   ...
   */
  get isV1050(): boolean {
    return this.ctx._chain.getEventHash('vesting.VestingCompleted') === '8595c46557b716a6558d5c3c5b5e030d3f02142fe0b61d05e610fd93cf865405'
  }
   ...
   */
  get isV9130(): boolean {
    return this.ctx._chain.getEventHash('vesting.VestingCompleted') === '3f29e569c8892fc5498d1cbbf899f93857a588bd2de0e83863f4feb02720d31f'
  }
...
export class VestingVestingUpdatedEvent {
   ...
   */
  get isV1050(): boolean {
    return this.ctx._chain.getEventHash('vesting.VestingUpdated') === '8c0d84dd8e9b03271a1e232ed94495cb572152b15ba462f8707a44d41a4b3a0e'
  }
   ...
   */
  get isV9130(): boolean {
    return this.ctx._chain.getEventHash('vesting.VestingUpdated') === 'b4bdbb5b3196efb87a7f4227949b25b0cbeb74a114db9da4496ee6071746bb66'
  }
