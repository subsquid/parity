...
module.exports = class paritytest1639049097201 {
    name = 'paritytest1639049097201'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "transfer" ("id" character varying NOT NULL, "sender_account" text NOT NULL, "receiver_account" text NOT NULL, "token_id" text NOT NULL, "amount" numeric NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_fd9ddbdd49a17afcbe014401295" PRIMARY KEY ("id"))`);
