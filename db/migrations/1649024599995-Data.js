module.exports = class Data1649024599995 {
  name = 'Data1649024599995'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "account" ("id" character varying NOT NULL, "substrate_account" text NOT NULL, "chain_id" character varying NOT NULL, "balance_id" character varying, CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))`)
